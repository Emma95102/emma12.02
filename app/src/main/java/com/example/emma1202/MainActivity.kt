...
import com.example.emma1202.ui.theme.Emma1202Theme
...
fun Animation(){
    ...
    val backgroundColor by animateColorAsState(
        if (appear) androidx.compose.ui.graphics.Color.Transparent else androidx.compose.ui.graphics.Color.Green,
